        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            <motion.div
              ...
              className="hidden lg:block absolute top-16 left-0 right-0 h-0.5 bg-gradient-to-r from-gray-500 via-gray-600 to-gray-500 opacity-30 origin-left"
            ></motion.div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Step Card with 3D */}
                  <Card3D className="bg-gray-800/60 backdrop-blur-sm border border-gray-600/30 rounded-xl overflow-hidden hover:border-gray-500/50 hover:shadow-2xl hover:shadow-gray-500/20 transition-all duration-300 text-center h-full">
                    {/* Step Number Badge */}
                    <motion.div
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
                    ...
                    >
                      <div className="w-10 h-10 rounded-full bg-gray-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                        {step.number}
                      </div>
                    </motion.div>
                    ...
                    <div className="relative h-40 w-full overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
                        <div className="p-3 rounded-lg bg-gray-800/80 backdrop-blur-sm border border-gray-600/30">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-gray-800/60 backdrop-blur-sm border border-gray-600/30 rounded-lg px-6 py-4">
