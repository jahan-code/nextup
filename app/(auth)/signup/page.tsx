        ...
        >
          <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-600/30 rounded-xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-300 to-gray-500 bg-clip-text text-transparent mb-2">Create Account</h1>
              <p className="text-gray-400">Sign up to start streaming</p>
            </div>
            ...
            <div className="mt-6">
              ...
              <button
                ...
                className="mt-4 w-full py-3 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-all flex items-center justify-center gap-2"
              >
            ...
            <p className="mt-6 text-center text-sm text-gray-400">
              ...
              <a href="/login" className="text-gray-400 hover:text-gray-300 font-medium">
                Sign in
              </a>
            </p>
          </div>
